...
//        }
    ...
    protected boolean initializePlayer() {
        if (player == null) {
            ...
            mediaItem = createMediaItems(intent);
            if (mediaItem == null) {
                return false;
            }

            Log.d(TAG, "mediaItem:" + mediaItem.mediaId);
            Log.d(TAG, "mediaItem:" + mediaItem.mediaMetadata.title);
            Log.d(TAG, "mediaItem:" + mediaItem.playbackProperties.uri);
    ...
    private MediaItem createMediaItems(Intent intent) {
        String m3u8Url = intent.getStringExtra("playUrl");
    ...
    private void updateButtonVisibility() {
        selectTracksButton.setEnabled(player != null);
    }
    ...
    private class PlayerEventListener implements Player.EventListener {
        ...
        public void onPlaybackStateChanged(@Player.State int playbackState) {
            ...
            if (playbackState == Player.STATE_ENDED) {
                ...
                setTitle(mediaItem.playbackProperties.uri.toString());
                Observable.just(1).delay(24, TimeUnit.SECONDS).subscribe(new Observer<Integer>() {
                    @Override
